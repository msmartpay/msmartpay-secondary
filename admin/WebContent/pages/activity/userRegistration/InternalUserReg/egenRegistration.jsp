        ...
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" >
              <tr>
                ...
                <strong>Recharge API Client Registration</strong> 
                </td>
              </tr>
				  ...
				  <table width="100%"  cellspacing="2" cellpadding="0" align="center">
                    <tr>
                      <td><h3 style="background:#993300; color:#FFF; text-align:center;">Personal Details</h3>
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center" class="mydata_tabl">
                            ...
                            <tr>
                              <td></td>
                              <td align="left" height="30"  class="form11">Company/Firm Name <font size="1" color="red" >*</font></td>
                              <td align="left">:</td>
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                             <input name="emailId"  type="email" tooltipText="Type Email ID in this box" onchange="checkemail();" />
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left"><input name="officeAddress" id="Oaddressline1" type="text"  tooltipText="Type Address 1 in this box" /></td>
                            </tr>
                            <tr>
                              <td></td>
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                                  <input type="text" name="resPincode" id="Rpin"  onkeypress="return digitonly(this,event)" maxlength="6" tooltipText="Type Pin Code in this box" /></td>
                            </tr>
                          </table>                          
                          </td>
                    </tr>
                    <tr>
                      <td><h3 align="center" style="background:#993300; color:#FFF;">PAN Details</h3>
                    		...
                    		<span style="margin-left:10px; color:#3E3E3E;"><input onclick="r_yes()" type="radio" name="same"  checked="checked" />&nbsp;Yes</span> 
                    ...
                    <tr>
                      ...
                      <input name="Submit" class="form11" type="reset" value="Reset" style="width:100px" />                      </td>
                    </tr>
                  </table>
				</form>	
...
var officeAddress=document.registration.officeAddress.value.replace(/^\s+|\s+$/, '');
if(officeAddress== null || officeAddress=="" )
{
alert("Your Form is Incomplete.");
document.registration.officeAddress.focus();
return false;
}
...
var resPincode=document.registration.resPincode.value.replace(/^\s+|\s+$/, '');
if(resPincode== null || resPincode=="" )
{
alert("Your Form is Incomplete.");
document.registration.resPincode.focus();
return false;
}
 document.registration.action="apiClientRegistration.action?param=registration";
...
xmlHttp.open("POST","apiClientRegistration.action?param=checkEmailId&emailId="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","apiClientRegistration.action?param=checkMobileNo&mobileNo="+type, true);
xmlHttp.send(null);
}
