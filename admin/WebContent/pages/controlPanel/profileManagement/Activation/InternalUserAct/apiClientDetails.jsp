...
<table width="240px" align="center" class="popup_table poptab" bgcolor="#FFFFFF">
...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
					...
					%>
                                          <tr  align="center" bgcolor="#993300">
                                            <td width="5%" style="color:#FFF;">S.N.</td>
                                            <td width="3%" style="color:#FFF;">
											<input type="hidden" name="size" value="<%=size%>"/>
                                                <input type="checkbox"  onchange="checkedAllCheckBoxes()" name="masterCheckBox" /></td>
                                            <td width="8%" style="color:#FFF;">Client ID</td>
                                            <td width="15%" style="color:#FFF;">Client Name</td>                                        
                                            <td width="15%" style="color:#FFF;">Company Name</td>
                                            <td width="12%" style="color:#FFF;">IP Address</td>
                                            <td width="10%" style="color:#FFF;">Balance</td>
                                             <td width="10%" style="color:#FFF;">Login Status</td>
                                            <td width="10%" style="border-right:1px solid #a74312;color:#FFF;">Block Status</td>
                                          </tr>
                                          <%
											for(int i=0;i<apiClientSearchList.size();i++){				  
				                             HashMap userMap=(HashMap)apiClientSearchList.get(i);
  ...
  <tr>
        ...
        <a href="#" style="text-decoration:none;"><input style="width:90px; float:left;" class="cls_btn" type="button" value="Edit Service" /> </a>
		
		<a href="javascript:deactivateApiClient();" style="text-decoration:none;"> <input class="cls_btn" type="button" value="Deactivate" /> </a>
		&nbsp;
		
		
		<a href="javascript:activateApiClient();") style="text-decoration:none;"><input class="cls_btn" type="button" value="Activate" /></a>
		&nbsp;&nbsp;
		
		
		
		<a style="cursor:pointer;text-decoration:none;"  href="javascript:blockApiClient();"><input class="cls_btn" type="button" value="Block" /></a>
		&nbsp;
		
		<a style="cursor:pointer;text-decoration:none;"  href="javascript:unblockApiClient();"><input class="cls_btn" type="button" value="Unblock" /></a>	
		</td>  </tr>
