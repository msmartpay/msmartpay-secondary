...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function submitForm(param){
		...
		var avalBal=${sessionScope.monthlyBalance};
		if(parseInt(amount)<1){
			
			alert('Top Up - Min Amount is 1');
			document.ConfirmForm.amount.value="";
			document.ConfirmForm.amount.focus();
			return false;
		}else if(parseInt(amount)>parseInt(avalBal)){
			alert('Top Up - amount exceed from your monyhly limit. Please re-try with less amount.');
			document.ConfirmForm.amount.value="";
			document.ConfirmForm.amount.focus();
			return false;
		}else{
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div align="center" style="width: 100%;">                 
                                            ...
                                            <ul class="nav nav-tabs">
                                                ...
                                                ${requestScope.requestAction } <strong>Available Limit : </strong>${sessionScope.monthlyBalance }
                                                </a></li>
                                                      			...
                                                      			<div class="table-color">
																	<table class="table">
																		...
																		<tr>
																			...
																			<td>
																				<div class="form-group col-md-12" >
						                                                            <label>${requestScope.mobile }</label>
						                                                       </div>
																			</td>	
																		</tr>	
																		<tr>
																			...
																			<div class="form-group col-md-12" >
																		   	...
																		   	<td>
																		   		<div class="form-group col-md-12" >
						                                                            <label>${requestScope.WalletName}</label>
						                                                       </div>
						                                                       	<input type="hidden" name="WalletCode" value="${requestScope.WalletCode}"   >
						                                                       	<input type="hidden" name="mobile" value="${requestScope.mobile}"   >
						                                                       	<input type="hidden" name="Status" value="${requestScope.Status}"   >
						                                                       	<input type="hidden" name="WalletName" value="${requestScope.WalletName}"   >
																		...
																		<c:choose>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" >
						                                                            <input type="text" name="amount" value="${requestScope.amount }" readonly="readonly" class="form-control" placeholder="Enter Amount">
						                                                        </div>
						                                                        </td>	
																			</tr>
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" >
				                                                            		<input type="text" name="narration" value="${requestScope.narration }" readonly="readonly" class="form-control" placeholder="Enter Remark">
				                                                        		</div>
				                                                        		</td>	
																			</tr>
	                                                       					...
	                                                       					<c:otherwise>
																				   ...
																				   <td>
																				   <div class="form-group col-md-12" >
							                                                            <input type="text" name="amount" value="${requestScope.amount }"  class="form-control" placeholder="Enter Amount">
							                                                        </div>
							                                                        </td>	
																				</tr>
																				<tr>
																				   ...
																				   <td>
																				   <div class="form-group col-md-12" >
					                                                            		<input type="text" name="narration" value="${requestScope.narration }"  class="form-control" placeholder="Enter Remark">
					                                                        		</div>
					                                                        		</td>	
																				</tr>
	                                                       					</c:otherwise>	
