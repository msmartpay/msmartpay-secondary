...
String vmnClientId=(String)session.getAttribute("clientId");
if(mdId==null)
{
...
/**Admin panel**/
.wrap_userDetail{margin:4px;border:1px solid #ccc;width:500px;float:right;
box-shadow:0 0 5px #bbb inset;background:#f8fdff;
}
.user_detl{width:450px;padding-bottom:5px;}


table.user_detl tr td p{font-weight:bold;float:right;font-size:12px;margin-top:5px;}
...
<table cellpadding="0" cellspacing="0" border="0" align="center" width="1000">
  <tr>
    <td width="100%"><table cellpadding="0" cellspacing="0" border="0" align="center" width="100%">
      <tr>
        <td width="75%" align="left" valign="middle" style="padding-left:20px" height="98"><img src="images/<%=header_home_image%>"  height="64" width="151"/></td>
        <td width="25%" valign="top">
		         <!--start of user detail--> 
         <div class="wrap_userDetail">
            <table class="user_detl" cellpadding="0" cellspacing="0">
               <tr>
                 <td><p class="blue">MDS ID : <span><strong><%=session.getAttribute("completeId")%></strong></span></p></td>
                 <td><p class="blue">Available Balance : <span><strong>Rs.<span><strong><%=FinalBalance%></strong></span></strong></span></p></td>
               </tr>
               
               <tr>
                 <td>&nbsp;</td>
                 <td><p class="wel_txt">Welcome <span><%=session.getAttribute("mdName")%></span></p></td>
               </tr>
            </table>
  ...
  <tr>
  <tr>
    <td valign="middle" align="left" style="padding-left:5px"><ul id="nav">
	<li class="top"><a href="doLoginAction.do?param=home" class="top_link" target="_parent"><span>Home</span></a></li>
	
		<li class="top"><a class="top_link"><span class="down">&nbsp;&nbsp;I&nbsp;&nbsp;</span></a></li>

	<li class="top"><a href="#" class="top_link"><span class="down">Channel</span></a>
		<ul class="sub">
        <li style="border-bottom:#00448d 1px solid;"><a href="distributorRegistration.do?param=register" target="_parent" class="fly">Add Distributor</a></li>
        <li style="border-bottom:#00448d 1px solid;"><a href="viewDistributor.do?param=viewDistributor" target="_parent"class="fly">View Distributor</a>
		 <li style="border-bottom:#00448d 1px solid;"><a href="viewAgent.do?param=viewAgent" target="_parent"class="fly">View Agents</a></li>
		  <li style="border-bottom:#00448d 1px solid;"><a href="userSearch.do?param=userSearch" target="_parent"class="fly">User Search</a></li>
	...
	<li class="top"><a href="#"  class="top_link"><span class="down">Funds</span></a>
	<ul class="sub">
			<li><a href="pushBalance.do?param=transferRequest">Push Balance - Distributor</a>
			</li>
            
            
						<li><a href="depositRequest.do?param=depositRequest" target="_parent">Deposit Request - Distributor</a></li>
            ...
            <li><a href="mdDepositRequest.do?param=amountRequest" target="_parent">My Deposit</a></li>
	...
	<li class="top"><a href="#"  class="top_link"><span class="down">Requests</span></a>
	...
	<ul class="sub">
		  <!-- <li style="border-bottom:#00448d 1px solid;"><a href="#" onClick="commingSoon()"  class="fly">Mobile Number Change</a></li>
		   ...
		   <li style="border-bottom:#00448d 1px solid;"><a href="#" onClick="commingSoon()"  class="fly">Ticker Upload</a></li>
		  <!-- <li style="border-bottom:#00448d 1px solid;"><a href="#" onClick="commingSoon()" class="fly">Balance Reversal</a>-->
		   <li style="border-bottom:#00448d 1px solid;"><a href="#" onClick="profileChange.do?param=profileChange" class="fly">Profile Change</a>
		   <li style="border-bottom:#00448d 1px solid;"><a href="#" onClick="commingSoon()" class="fly">Web/SMS Activation</a>
		 <!--  <li style="border-bottom:#00448d 1px solid;"><a href="resendMPIN.do?param=requestResendMpin" class="fly">Resend MPIN</a>-->
		 	
		    <li style="border-bottom:#00448d 1px solid;"><a href="http://www.mgencash.com/" target="_blank" class="fly">Mobile App</a>
			 <li><a href="http://www.dndcheck.in/" target="_blank" class="fly">DND Check </a>
	...
	<ul class="sub">
	       ...
	       <li><a href="accountStatement.do?param=accountStatement" >MDS</a></li>
		 ...
		 <!--   <li><a href="transferReport.do?param=distToAgent" >Distributors 2</a></li>-->
		   ...
		   <li><a href="SearchTran.do?param=SearchTranPage">Transaction Status</a></li>
		   <%
			  if(clientFlag.equals("1") || clientFlag.equals("2") || clientFlag.equals("0")){
			%>
		    <li><a href="SMSResponse.do?param=SMSResponse" >SMS Response</a></li>
		<%}%>
    ...
    <li class="top"><a href="mdProfile.do?param=myProfile" target="_parent"class="top_link"><span style="padding-left:480px;">My Profile</span></a></li>
    
   
    
    <li class="top"><a class="top_link"><span class="down">&nbsp;&nbsp;I&nbsp;&nbsp;</span></a></li>
    
    <li class="top"><a href="doLoginAction.do?param=logout" target="_parent"class="top_link"><span>Log&nbsp;Out</span></a></li>
    
    
    <div align="center"><span style="padding-right:380px"> </span>
    </div>
