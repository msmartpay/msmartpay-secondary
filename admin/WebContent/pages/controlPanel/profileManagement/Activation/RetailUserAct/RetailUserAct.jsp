...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
    ...
    <td  align="center" width="100%" valign="top">
     <table cellpadding="0" cellspacing="0"  width="90%" align="center" border="0" class="newbg">
		...
		<tr>
          ...
          <table class="mydata_tabl" cellpadding="0" cellspacing="0" width="100%" align="center"  border="0">
		   <tr><td colspan="4" height="8"></td>
			  		  </tr>
                     
		   <tr>
                <td  width="100%" valign="bottom" height="15" align="left" class="heading_mgs">Retail User<%=loginType %></td>                
              </tr>
		  ...
		  <table cellpadding="0" cellspacing="0" width="86%"  border="0" align="center"  class="mydata_tabl" id="border">
					...
					<tr>
					  ...
					  <tr>
                      <td width="19%"></td>
                      <td  align="left"  width="22%">Select User Type</td>
                    ...
                    <tr id="portalIdDiv">
                      <td></td>
                      <td  align="left">Select Portal</td>
                      <td align="left">:</td>
                      <td align="left">
				...
				<select name="portalType" id="portal" style="display:none"><option selected="selected">TEP</option><option>REP</option><option>Both</option>
					...
					<select name="portalType" id="portal" style="display:none; width:80px; font-family:'Trebuchet MS';">
                    <option selected="selected">Select</option>
                    <option>TEP</option><option>REP</option><option>Combo</option>
					</select>
					</td>
	                    </tr>
						<%}
                    ...
                    <!--dynamic user id tr start-->
                    
                    <tr id="mds_tr">
                      <td width="19%"></td>
                      <td  align="left">User ID</td>
                      <td align="left">:</td>
                      <td align="left"><input type="text"   name="userId" onselectstart="return false"  autocomplete=off/ tooltiptext="Input Value Example: MDUP10004,DSUP2863,AG124360"></td>
                    </tr>
                    ...
                    <tr id="status" style="block">
                      <td width="19%"></td>
                      <td  align="left"  width="22%">User Status Type</td>
                      <td align="left" width="14%">:</td>
                      <td align="left"  width="45%"><Select type="text"  name="status">
                          <option value="all">All</option>
                          <option value="Activate">Active</option>
                          <!--<option value="inactive">Inactive</option>
                          <option value="PartiallyActive">Partialy Active</option>
                          <option value="partiallyinactive">Partialy Inactive</option>-->
 ...
 <tr><td></td>
  ...
  <tr><td colspan="4" height="62"></td></tr>
...
document.searchForm.action="agentActivation.action?param=searchUserType";
...
document.searchForm.action="distributorActivation.action?param=searchUserType";
document.searchForm.submit();
}
...
document.searchForm.action="mdsActivation.action?param=searchUserType";
document.searchForm.submit();
}
