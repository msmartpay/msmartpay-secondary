  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" >
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Administrative User Registration</td>
              </tr>
              <tr>
				...
				<form name="registration" method="post" >
				  <table width="100%"  cellspacing="2" cellpadding="0" align="center" >
                      ...
                      <td><h3 align="center" class="hd tabulardata">Personal Details</h3>
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center"  class="mydata_tabl">
							...
							<tr>
                              ...
                              <input name="dob"  type="text"  id="datepicker"   readonly="true"/></td>
							</tr>
							...
							<tr>
                              ...
                              <td width="5%" align="left">:</td>
                              <td width="46%" align="left"><select name="gender" id="gender">
                    ...
                    <tr>
                      <td><h3 align="center" class="hd tabulardata">PAN Details</h3>
                    		...
                    		<span style="margin-left:0px; color:#3E3E3E;"> <input onclick="r_yes()" type="radio" name="same"  checked="checked" />&nbsp;Yes</span> 
                  			<span style="margin-left:10px; color:#3E3E3E;"> <input onclick="r_no()" type="radio" name="same"  /> &nbsp;No</span>                                </td>
                              </tr>
                              <tr id="tr_1">
                                <td></td>
                    ...
                    <tr>
                      ...
                      <input name="Submit2" type="button" value="Submit" class="cls_btn" onclick="submitForm()"/>
                      <input name="Submit"  type="reset" value="Reset" class="cls_btn"   onclick="reset();"/>                      </td>
                    </tr>
                  </table>
				</form>	
...
return false;
 ...
 document.registration.action="adminUserRegistration.action?param=registration";
...
xmlHttp.open("POST","adminUserRegistration.action?param=checkUserEmail&loginUserEmail="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","adminUserRegistration.action?param=checkUserMobile&Mobile="+type, true);
xmlHttp.send(null);
}
