	                    ...
	                    <div class="col-md-12">
	                        <div class="white-box">
	                            ...
	                            <div class="table-responsive">
	                            	...
	                            	<div class="col-md-12 form-group"><h3 class="box-title">DTH Connection Request</h3></div>
                                    <div class="col-md-5" >
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="mobile">
                                                    <form name="DTHConnection" method="post" action="dthConnection.action?param=dthConnectionRequest">
                                                        ...
                                                        <button type="submit" id="submitdthconn" onclick="submitForm()" class="btn btn-success waves-effect waves-light m-r-10">Submit Request</button>
