                                  ...
                                  <tbody>
                                    ...
                                    <tbody >
                                        <tr class="hd tabulardata" align="center" >
                                            ...
                                            <td width="7%" align="center" class="right_border"><strong style="color:#FFF;">User ID</strong></td>
											...
											<td width="10%" align="center"><strong style="color:#FFF;">Block Status</strong></td>
											<td width="10%" align="center" style="border-right:1px solid #930;"><strong style="color:#FFF;">User Type</strong></td>
                                          </tr>
										  ...
										  %>
                                           <tr bgcolor="#ffffff" align="center" class="value_reg">
                                            ...
                                            <td align="center" style="border-bottom:1px solid #930;"><%=(String)map.get("userName")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("loginStatus")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=(String)map.get("blockStatus")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;border-right:1px solid #930;"><%=map.get("userType")%></td>
											</tr>
											<%}%>
                                      </tbody>
                                      </table></td>
