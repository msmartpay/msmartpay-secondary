...
public class ServiceLocator extends org.apache.axis.client.Service implements in.aadhaarshila.Service {
    ...
    private java.lang.String ServiceSoap_address = "http://vyapardwar.co.in/Service.asmx";
    ...
    public in.aadhaarshila.ServiceSoap getServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            in.aadhaarshila.ServiceSoapStub _stub = new in.aadhaarshila.ServiceSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (in.aadhaarshila.ServiceSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                in.aadhaarshila.ServiceSoapStub _stub = new in.aadhaarshila.ServiceSoapStub(new java.net.URL(ServiceSoap_address), this);
                _stub.setPortName(getServiceSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://softsolutionzone.in/", "Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://softsolutionzone.in/", "ServiceSoap"));
        }
