	...
	public String execute()
		...
		try
		{
			...
			if("BusPage".equalsIgnoreCase(param)){
				...
				ArrayList<HashMap<String, Object>> arrayList =apiCall.getBusSearch(originId,destinationId ,travelDate );

				if(arrayList!=null && arrayList.size()>0){
					
					request.setAttribute("AvalableList", arrayList);
					System.out.println("busList"+ arrayList.size());
