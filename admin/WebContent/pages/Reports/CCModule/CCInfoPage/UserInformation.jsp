...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
          ...
          <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" bgcolor="">
              <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0">
                    ...
                    <tr>
                      <td  valign="middle" align="center" class="dyn_mgs"><%=message%></td>
                    </tr>
                    
                    <tr>
                      <td colspan="4"  id="border">
					  <form name="SubmitForm" method="post">
					   <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0" class="mydata_tabl">
                       <tr><td colspan="100%" height="15px"></td></tr>
					   <tr>
                       <td width="20%"></td>
					  ...
					  <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0"  class="form11">
                          <tr>
                            <td valign="top" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tbody>
                                  <tr>
                                    <td height="15" align="left" valign="middle" style="padding-left:15px;"  class="big1"></td>
                                  </tr>
                                  <tr>
                                    <td valign="top">
									...
									<table cellspacing="0" cellpadding="0" width="100%" align="center" class="tbls"  bgcolor="#a74312" >
                                        <tbody>
                                          <tr align="center" height="20" class="hd">
                                            <td  align="center" rowspan="2"><strong style="color:#FFF;">S.N.</strong></td>
                                            <td align="center" rowspan="2"><input type="checkbox"  id="selectall" /></td>
                                            <td width="13%" rowspan="2" align="center"><strong style="color:#FFF;">MDUP10004</strong></td>
                                            ...
                                            <td align="center" style="padding-left:8px;border-right:1px solid #930;"><strong style="color:#FFF;">Remark</strong></td>
                                          </tr>
                                          <tr align="center" height="20" class="hd">
                                            <td width="10%" style="padding-left:0px"><strong style="color:#FFF;">Min Deposit</strong></td>
                                            <td width="7%" style="padding-left:0px"><strong style="color:#FFF;">Min Rate</strong></td>
                                            <td width="7%" style="padding-left:0px"><strong style="color:#FFF;">Slab</strong></td>
                                            ...
                                            <td align="center" valign="middle" style="padding-left:0px; border-right:1px solid #930;"><strong style="color:#FFF;">Remember</strong></td>
                                          </tr>
  ...
  <td width="3%" align="center" valign="middle"><input type="checkbox" class="case" name="checkpartial" id="chek<%=i %>" value="<%=i%>" />
	</td>
...
<div  class="show_div hide" style="position:absolute;">
 ...
 <table width="380" border="0" cellspacing="0" cellpadding="0" style="background-color:#fbf7eb; border:3px solid #a74312;">
    ...
    <tr>
	<%
	flag=(String)map.get("clientFlag");
	...
	%>
      <th width="140" align="left" bgcolor="" style="padding-left:5px;border:none;" scope="row"><strong>Portal ID</strong></th>
      <td width="15" bgcolor="#fbf7eb" style="border:none;">:</td>
      <td width="156" bgcolor="#fbf7eb" style="border:none;"><%=map.get("clientID").toString()%></td>
    </tr>
    <tr>
    ...
    <tr>
      <th align="left" bgcolor="" style="padding-left:5px;border:none;" scope="row"><strong>Portal Category</strong></th>
      <td bgcolor="#FBF7EB" style="border:none;">:</td>
      <td bgcolor="#FBF7EB" style="border:none;"><%=map.get("clientCategory").toString()%></td>
  </tr>
    <tr>
      <th align="left" bgcolor="" style="padding-left:5px;border:none;" scope="row"><strong>Portal Type</strong></th>
      <td bgcolor="#FBF7EB" style="border:none;">:</td>
      <td bgcolor="#FBF7EB" style="border:none;"><%=clientType%></td>
  </tr>
   <tr>
      <td height="5" colspan="3" align="center" valign="middle" style="padding-left:0px;border:none"><img src="images/bg_image24.jpg" width="278" height="1" /></td>
  </tr>
    <tr>
      <th align="left" bgcolor="" style="padding-left:5px;border:none;" scope="row"><strong>User ID</strong></th>
      <td bgcolor="#FBF7EB" style="border:none;">:</td>
      <td bgcolor="#FBF7EB" style="border:none;"><%=map.get("userID").toString()%></td>
  </tr>
    <tr>
      <th align="left" bgcolor="" style="padding-left:5px;border:none;" scope="row"><strong>Company Name</strong></th>
      <td bgcolor="#FBF7EB" style="border:none;">:</td>
      <td bgcolor="#FBF7EB" style="border:none;"><%=map.get("companyName").toString()%></td>
  </tr>
    <tr>
  ...
  <td align="center" valign="middle" style="padding-left:0px"><span class="style31" style="font-family:'Trebuchet MS'; font-size:12px;                                                font-weight:bold;"><%=map.get("userCategory")%>
  ...
  <input name="userMinDepositeRate<%=i%>" type="text" id="lkk"  onkeypress="retet" value="<%=map.get("userMinRate").toString()%>" size="10"/></td>
...
<div  class="show_div hide" style="position:absolute">
 <table width="293" border="1" cellspacing="0" cellpadding="0" style="background-color:#fbf7eb; border:3px solid #a74312">
  ...
  <input type="hidden" name="typeOfuser" value="<%=typeOfuser%>"/>
    <select name="AVIDBlock<%=i%>" id="select2" style="font-family:'Trebuchet MS'; font-size:12px; color:#930; font-weight:bold;" >      
	<%
  ...
  <td align="center"><span class="style31" style="font-family:'Trebuchet MS'; font-size:12px; font-weight:bold;">
    <select name="AVIDUndertaking<%=i%>" id="select3" style="font-family:'Trebuchet MS';color:#930; font-size :11px; font-weight:bold;" >
		<%
  ...
  <td align="center"><span class="style31" style="font-family:'Trebuchet MS'; font-size:12px;font-weight:bold;">
    <select name="VerifyPan<%=i%>" id="select5" style="font-family:'Trebuchet MS';color:#930; font-size:11px; font-weight:bold;" >
	<%
  ...
  <td width="18%" align="center" valign="middle" style="padding-left:0px;border-right:1px solid #930;"><span class="style31">
    <input type="text" name="remark<%=i%>" size="25" id="remark<%=i+1%>" value="<%=map.get("userRemark").toString()%>" />
  </span></td>
  </tr>
   ...
   <tr>
    <td width="100%" height="104" align="center" valign="bottom"></td>
  </tr>
  <tr>
