                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div align="center" style="width: 100%;">                 
                                            ...
                                            <div class="tab-content" style="padding: 0px 28px;">
                                                    ...
                                                    <form action="" name="ConfirmForm" method="post" >
                                                       ...
                                                       <div class="table-responsive">
																	...
																	<table class="table" style="margin-bottom: 0px;">
																		...
																		<tr>
																			...
																			<div class="form-group col-md-6" style="margin-bottom: 0px;">
					                                                            <label>${requestScope.queryRemittanceRequestResponse.transactionRefNo }</label>
					                                                       </div>
																			</td>	
																		</tr>
                                                       						...
                                                       						<tr>
																				<td>
																				<div class="form-group col-md-12" style="margin-bottom: 0px;">
																					<label>Transfered Type</label>
																			   </div>
																			   </td> 
																			   <td> : </td> 
																			   <td>
																			   <div class="form-group col-md-6" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.queryRemittanceRequestResponse.remittanceType }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			...
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-6" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.queryRemittanceRequestResponse.amount }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			...
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.bankDetails.beneName }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.bankDetails.bankName }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.bankDetails.accountNumber }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			...
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" style="margin-bottom: 0px;">
						                                                            <label>${requestScope.bankDetails.Ifsc }</label>
																			   </div>
						                                                        </td>	
																			</tr>
																			...
																			<tr>
																			   ...
																			   <td>
																			   <div class="form-group col-md-12" style="margin-bottom: 0px;">
				                                                            		<label>${requestScope.queryRemittanceRequestResponse.responseMessage }</label>
																			   </div>
				                                                        		</td>	
																			</tr>
                                                        ...
                                                        <div class="form-group col-md-6" align="right">
															<button style="width:150px;" onclick="print()" type="button" class="btn btn-primary btn-inline">
															Print
															</button>
													   </div>
