				  ...
				  <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Cutoff for MDS of All Client</td>
                          </tr>
                          <tr>
                            <td valign="top" width="100%"><table width="90%"  cellspacing="0" cellpadding="0" align="center" id="border"  class="mydata_tabl" >
                                <tr>
                                  <td width="15%"></td>
                                  <td width="33%" height="35"  align="left"><strong>Set Cutoff Amount for All MDS</strong></td>
                                  <td width="15%"  align="center">:</td>
                                  <td width="37%" align="left"><input name="cutoffAmount" type="text" id="cutoffAmountID" onkeypress="return digitonly(this,event)" maxlength="7"/></td>
                                </tr>
                                  ...
                                  <td align="center" colspan="4"><div  id="div1" style="display:none;">
                                      <table width="100%"  cellspacing="0" cellpadding="0" align="center" class="border1">
                                        <tr>
                                          ...
                                          <input name="SecondcutoffAmount" id="SecondcutoffAmountMD" type="text" onkeypress="returndigitonly(this,event)" maxlength="7" /></td>
                                        </tr>
                                      </table>
                                    </div></td>
                                </tr>
                 ...
                 <%if(cutOffBy.equalsIgnoreCase("ByClientId")){%>
				  ...
				  <tr>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td  width="100%" valign="middle" height="40" align="left" style="padding-left:60px" class="logintxt" ><strong>Cutoff for MDS of Client ID </strong>(<%=EnterUserId%>)</td>
                          </tr>
                          <tr>
                            <td valign="top"><table width="90%"  cellspacing="0" cellpadding="0" align="center" id="border"  class="form11" >
                                <tr>
                                  <td width="15%"></td>
                                  <td width="33%" height="35"  align="left"><strong>Set Cutoff Amount for All MDS</strong></td>
                                  <td width="15%"  align="center">:</td>
                                  <td width="37%" align="left"><input name="cutoffAmount" id="cutoffAmountClient" type="text" class="style2" style="width:70px"  onkeypress="return digitonly(this,event)" maxlength="5"/></td>
                                </tr>
                                  ...
                                  <td align="center" colspan="4"><div  id="div2" style="display:none;">
                                      <table width="100%"  cellspacing="0" cellpadding="0" align="center" class="border1">
                                        <tr>
                                          ...
                                          <td width="33%" height="35"  align="left"><strong>Set Cutoff Amount Limit for All DS</strong></td>
                                          <td width="15%"  align="center">:</td>
                                          <td width="37%" align="left"><input name="SecondcutoffAmount"  id="cutoffAmountClient"type="text" onkeypress="return digitonly(this,event)" maxlength="7"/></td>                                <input type="hidden"  value="<%=EnterUserId%>" name="userId" />
										   <input type="hidden" value="<%=ipAddress%>" name="ipAddress" />
                                        </tr>
                                      </table>
                                    </div></td>
                          ...
                          <tr>
                            <td align="center" width="100%"><table width="86%"  cellspacing="0" cellpadding="0" align="center" bgcolor="#a74312" class="tbls">
                                ...
                                <tr bgcolor="#ffffff" align="center">
                                  <td height="25" style="text-transform:uppercase;"><%=userId%></td>
                                  <td><%=EnterUserId%></td>
                                  <td><%=getMdData.get("UserName")%></td>
                                  <td><%=getMdData.get("stringTot")%></td>
                                  <td><%=getMdData.get("useString")%></td>
                                     <td class="mdcolor"><%=getMdData.get("cutString")%></td>
...
<tr>
  <td width="100%" valign="top" align="center" height="233">
</td>
</tr>
<tr>
