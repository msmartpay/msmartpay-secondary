			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0"  >
					<tr>
						...
						<table cellpadding="0" cellspacing="0" width="100%" align="center">
							<tr>
								<td height="40" align="left" valign="middle" class="heading_mgs">SMS Service Management</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<form name="myforms" method="post" action="ServiceManagement.action?param=SMSServiceUpdate">
