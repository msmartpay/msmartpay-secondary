...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function submitForm(senderid){
		...
		$('#resultLoading').show();
		document.verifyAccount.action='verifyAccounteko.action';
	...
	function getBankStatus(BankCode){
		...
		if(BankCode==''){
			...
			$.ajax({
			 	url:"bankVerificationStatuseko.action?BankCode="+BankCode+"&SenderId="+SenderId,
				type : "GET",
				dataType: "text",
	                                   ...
	                                   <form class="floating-labels" name="verifyAccount" onsubmit="return submitForm();">
	                                    <input type="hidden" class="form-control" name="Service" id="input1" value="mobile">
											...
											<div class="col-md-12 form-group">
	                                       		<h3 class="box-title">EAccount Verification</h3>
