		...
		try 
		{
			...
			workbook.close();
                   ...
                   /* HSSFWorkbook wb = new HSSFWorkbook();
       		  		...
       		  		rowhead.createCell((short) 0).setCellValue("Distributor Id");
       		        rowhead.createCell((short) 1).setCellValue("Agent Id");
       		  		rowhead.createCell((short) 2).setCellValue("Transaction Id");
       		  		rowhead.createCell((short) 3).setCellValue("DateOfTransaction");
       		  		rowhead.createCell((short) 4).setCellValue("Service");
       		  		rowhead.createCell((short) 5).setCellValue("Requested Amount");
       		  		rowhead.createCell((short) 6).setCellValue("Commission");
       		  		rowhead.createCell((short) 7).setCellValue("Transaction Amount");
       		  	    rowhead.createCell((short) 8).setCellValue("Status");
       		  	   // rowhead.createCell((short) 9).setCellValue(headerName);
					 ...
					 while(rs.next())
					 {
					        ...
					        row.createCell((short) 0).setCellValue((String)rs.getString(1));
				            row.createCell((short) 1).setCellValue((String)rs.getString(2));
				  			row.createCell((short) 2).setCellValue((String)rs.getString(3));
				  			row.createCell((short) 3).setCellValue((String)rs.getString(4));
				  			row.createCell((short) 4).setCellValue((String)rs.getString(5));
				  			row.createCell((short) 5).setCellValue((String)rs.getString(7));
				  			row.createCell((short) 6).setCellValue((String)rs.getString(8));
				  			row.createCell((short) 7).setCellValue((String)rs.getString(9));
				  			row.createCell((short) 8).setCellValue((String)rs.getString(11));
