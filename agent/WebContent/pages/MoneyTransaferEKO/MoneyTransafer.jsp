...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
   	...
   	function verifyAccountPage(){
   		$('#resultLoading').show();
   		document.getElementById('verifyAccount').href="verifyAccountpageeko.action?SenderId=${requestScope.findSenderlist.sdMap.SenderId}";
   	}
   	...
   	function submitEkyc(senderId){
   		document.getElementById('ekyc').href='dmrCustomerKyceko.action?SenderId='+senderId;
   	}
   	</script>
</head>
<body>
				...
				<div class="container" style="width:100%;" >				
					...
					<div class="row">
	                            ...
	                            <div class="col-md-5 form-group">
	                                   <form class="floating-labels " action="findSendereko.action" onsubmit="return findSender()">
	                                    	<input type="hidden" class="form-control" name="Service" id="input1" value="mobile">
									 	   <div class="col-md-12 form-group">
	                                           <h3 class="box-title">EDomestic Money Transfer</h3>
	                                       </div>
	                            ...
	                            <div class="col-md-7 form-group" style="padding: 3%;border: 1px solid #ccc;">
									...
									<div class="col-md-4 form-group">
										<p ><strong>Total Limit :</strong>&emsp;&emsp;<span style="color: red;">${requestScope.findSenderlist.slimitMap.SenderLimit}</span></p>
									</div>
									<div class="col-md-4 form-group">
									...
									<div class="col-md-12 form-group">
										<div class="col-md-4 form-group">
		                            		<a id="addbene" onclick="addbene('addbeneficiarypageeko.action?SenderId=${requestScope.findSenderlist.sdMap.SenderId}')" href="#">(+)New Beneficiary</a>
		                            	</div>
		                            	<div class="col-md-4 form-group">
		                            	...
		                            	<div class="col-md-4 form-group">
		                            		<a  href="refundekopage.action?SenderId=${requestScope.findSenderlist.sdMap.SenderId}" id="refund">Refund Transaction</a>
		                            	</div>
		                            </div>
		                            
		                            <%-- <c:if test="${ requestScope.findSenderlist.slimitMap.KycStatus !='Full Kyc'}">
						                <div class="col-md-12 form-group" style="margin-top: 10px;">
						                
							                <div class="col-md-1" align="left">
												<img alt="image" src="images/rightarrow.gif" height="50" width="60">
											</div>
							                <div class="col-md-11" align="left">
													
													<a id="instantekyc" class="Kyc divlbl" href="EkycMobileApp.jsp?SenderId=${requestScope.findSenderlist.sdMap.SenderId}&agentId=${sessionScope.agentID}&AutKey=${sessionScope.TxnKey}" 
													target="_blank" style="text-decoration: underline;"><span style="color: red;">Update instant KYC to increase customer limit and decrease transaction charge</span></a>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <c:forEach var="BeneList" items="${requestScope.findSenderlist.BeneList}" varStatus="loop">
                                        <tr>
                                            ...
                                            <td><a id="delete${loop.index}" onclick="deleteBene('deleteBeneficiaryeko.action?SenderId=${requestScope.findSenderlist.sdMap.SenderId}&BeneId=${BeneList.RecipientId }','${loop.index}')" href="#">Delete</a></td>
                                        </tr>
                                        </c:forEach>
