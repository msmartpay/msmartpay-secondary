...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<%
	HashMap mapdata=(HashMap) request.getAttribute("AccountStmtData");
...
<table style="width:75%; height:400px; margin:auto;" border="0" align="center" cellpadding="0" cellspacing="0" >
                       ...
                       <tr>
                          ...
                          <td width="30%"   valign="top"   align="left"><strong class="tra_2">Bank Reference ID</strong></td>
                          <td width="2%" valign="top" align="left"   class="tra_2">:</td>
						  
                          <td width="40%" valign="top" align="left"   class="tra_2"><%=mapdata.get("BandReferenceId")%></td></tr>
                       ...
                       <tr>
                          ...
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("TranNo")%></td></tr>
    
                       <tr>
                          
                          <td  valign="top" align="left" class="tra_2"><strong>Date of Transaction</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("dot")%></td>
                      </tr>
                      
                      <tr>
                          
                          <td  valign="top" align="left" class="tra_2"><strong>Time of Transaction</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("tot")%></td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("reqAmount")%></td>
                      </tr>
    
  
                       <tr>  
                          <td  align="left"  valign="top" class="tra_2"><strong>Beneficiary Name</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("BeneName")%></td>
                       </tr>
						<tr>
						   <td  align="left"  valign="top" class="tra_2"><strong>Bank Account</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("BeneAcount")%></td>
                         </tr>
                         
                         <tr>  
                          <td  align="left"  valign="top" class="tra_2"><strong>Bank Name</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("BankName")%></td>
                       </tr>
						<tr>
						   <td  align="left"  valign="top" class="tra_2"><strong>Bank IFSC</strong></td>
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("BankIfsc")%></td>
                         </tr>
