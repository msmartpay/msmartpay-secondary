...
<link rel="stylesheet" href="//code.jquery.com/ui/1.10.4/themes/smoothness/jquery-ui.css">
  ...
  <script>
  $(function() {
    $( "#datepicker1,#datepicker2" ).datepicker({dateFormat:"yy-mm-dd",maxDate:0});
  });
  </script>
                          ...
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center"  class="mydata_tabl" border="0">
                            ...
                            <tr>
                              ...
                              <td align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="left" class="mydata_tabl">
                                  <tr>
                                    <td align="left" valign="middle"><input name="fromDate" type="text"  id="datepicker1" size="15" readonly="readonly"  value="<%=beforeDate%>"/>
                                        </td>
                                  </tr>
                              </table></td>
                            </tr>
							<tr>
                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                                  <tr>
                                    <td align="left" valign="middle"><input name="toDate" type="text"  id="datepicker2" size="15" readonly="readonly"  value="<%=curdate%>"/>
                                        </td>
                                  </tr>
                              </table></td>
                            </tr>
