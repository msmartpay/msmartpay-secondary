		  ...
		  <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0"  class="mydata_tabl" id="border">
                ...
                <tr>
				    ...
				    <tr>
				      ...
				      <td  align="left">:</td>
				      <td width="47%" align="left"><input type="text"  name="mobileNo" id="mobileno" maxlength="10" /></td>
				      </tr>
					<tr>
				      <td ></td>
			  ...
			  <tr><td valign="top" align="center"><div id="#" style="display:">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tbody>
                                    <tr>
                                      <td height="40" align="left" valign="middle" class="heading_mgs">Master Distributor Detail</td>
                                    </tr>
								    <tr>
                                    ...
                                    <tbody >
                                        <tr class="hd tabulardata" align="center" ">
                                            <td width="6%" align="center" height="25"  style="border-left:none;"><strong style="color:#FFF;">S.N.</strong></td>
                                            <td width="6%" align="center" class="right_border"><strong style="color:#FFF;">Portal ID</strong></td>
                                            <td width="11%" align="center" style="padding-left:8px;" class="right_border"><strong style="color:#FFF;">Portal Name</strong></td>
                                            <td width="7%" align="center" class="right_border"><strong style="color:#FFF;">MD ID</strong></td>
                                            <td width="14%" align="center" class="right_border" style="padding-left:8px;"><strong style="color:#FFF;">Company Name</strong></td>
										  ...
										  %>
                                           <tr bgcolor="#ffffff" align="center" class="value_reg">
                                            ...
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("ClientcompanyName")%></td>
...
var mobileNo=document.SearchUserForm.mobileNo.value;
var emailID=document.SearchUserForm.emailID.value;
