   ...
   <td  align="center" width="100%" valign="top"> <table cellpadding="0" cellspacing="0"  width="90%" align="center" border="0">
		...
		<tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" style="margin-left:100px" border="0">
		    ...
		    <tr>
                <td  width="100%" valign="bottom" height="40" align="left" style="font-size:13px; font-family:'Trebuchet MS'; color:#930; font-weight:bold;" >Credit</td>                
              </tr>
            ...
            <form method="post" name="CreditQueryForm">
		  ...
		  <table cellpadding="0" cellspacing="0" width="83%" align="left" border="0"  class="mydata_tabl" id="border">
				    ...
				    <tr>
				     ...
				     <tr>
				      ...
				      <td width="55%" colspan="4" align="left"><select  name="dbType" onchange="dumy">
				      ...
				      <td width="6%" align="left">:</td>
				      <td colspan="4" align="left"><select  name="typeOfUser" onchange="dumy">
				        <option value="select" selected="selected">Select</option>
				      ...
				      <td width="6%" align="left">:</td>
				      <td colspan="4" align="left"><input type="text"  class="tabl2" name="amount" onkeypress="return digitonly(this,event)" maxlength="5"/></td>
				      </tr>
				      ...
				      <td width="6%" align="left">:</td>
				      <td colspan="4" align="left"><input type="text"  class="tabl2" name="remark"/>
					  <input type="hidden" name="ipAdd" value="<%=ipAdd%>"/></td>
				      </tr>
				      ...
				      <td width="6%" align="left">:</td>
				      <td colspan="4" align="left"><input name="idproofFile" type="file" class="style2" value="Attach" id="file" size="25"/></td>
				      </tr>
                ...
                <td  align="left"></td>
				<td align="left"></td>
				<td colspan="4" align="left" style="padding-left:0px">  <input name="Submit2" type="button" value="Submit" class="cls_btn" id="sms" onclick="validate()"/></td>
                </tr>
                 <tr>
                      <td colspan="7" height="15"></td>
                    </tr>
...
function validate( ){
var dbType=document.CreditQueryForm.dbType.value;
var typeOfUser=document.CreditQueryForm.typeOfUser.value;
var userID=document.CreditQueryForm.userID.value;
var amount=document.CreditQueryForm.amount.value;
var remark=document.CreditQueryForm.remark.value;
if(dbType=="select"){
...
document.CreditQueryForm.action="dbTask.action?param=creditQuery";
document.CreditQueryForm.submit();
}
