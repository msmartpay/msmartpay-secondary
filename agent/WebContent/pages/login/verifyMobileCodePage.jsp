							...
							<div class="box">
								<form action="home.html" method="POST" role="form">
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Enter Mobile Verification Code">
									</div>
									
									<button type="submit" onclick="javascript=this.disabled = true; form.submit();" class="btn btn-primary btn-inline">Submit Request</button>&nbsp; &nbsp; &nbsp;
								</form></div>
                                </div>
                                </div>
