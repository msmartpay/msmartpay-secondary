...
var serviceName=document.update.userList.value;

alert("serviceName"+serviceName)

if(serviceName=="RailMD")
{
var criteria=document.update.CommCriteria.value;
if(criteria=="RailMD"){
	alert("RailMD")
document.update.action="UpdateMDRailWithMDID.action";
document.update.submit();
}	
if(criteria=="clientID")
{
document.update.action="UpdateMDRailWithClientId.action";
document.update.submit();
}
...
//-----------------
if(serviceName=="RailDS")
{
var criteria=document.update.CommCriteria.value;
if(criteria=="RailDS"){
	alert("RailDS")
document.update.action="UpdateDSRailWithDSID.action";
document.update.submit();
}	
if(criteria=="RailMD"){
	alert("RailMD")
document.update.action="UpdateDSRailWithMDID.action";
document.update.submit();
}	
if(criteria=="clientID")
{
document.update.action="UpdateDSRailWithClientId.action";
document.update.submit();
}
...
//--------------------
//-----------------
if(serviceName=="Railagent")
{
var criteria=document.update.CommCriteria.value;
alert("criteria----"+criteria)
if(criteria=="Railagent"){
	alert("RailDS")
document.update.action="UpdateAgentRailWithAgentID.action";
document.update.submit();
}
if(criteria=="RailDS"){
	alert("RailDS")
document.update.action="UpdateAgentRailWithDSID.action";
document.update.submit();
}	
if(criteria=="RailMD"){
	alert("RailMD")
...
if(criteria=="clientID")
{
document.update.action="UpdateAgentRailWithClientId.action";
document.update.submit();
}
