...
System.out.println("user_Id in JSP Page "+user_Id);
%>
  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Master Distributor Registration</td>
              </tr>
				<tr>
				...
				<form name="registration" method="post" enctype="multipart/form-data">
				  <table width="100%"  cellspacing="2" cellpadding="0" align="center" >
                    <tr>
                      <td><h3 align="center" class="hd tabulardata">Personal Details</h3>
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center"  class="mydata_tabl">
                            ...
                            <tr><td  colspan="10" align="center" class="dyn_mgs"></td></tr>
							<tr><td  colspan="10" align="center">&nbsp;</td></tr>
                            
                            <%if(loginUserType.equalsIgnoreCase("superadmin")||loginUserType.equalsIgnoreCase("activityAdmin")||loginUserType.equalsIgnoreCase("activityUser")){%>
                            <tr>
                              <td width="22%"></td>
                              <td width="33%" height="30" align="left"  class="form11">Client ID <font size="1" color="red" >*</font></td>
                              <td width="5%" align="left">:</td>
                              <td width="46%" align="left"><input type="text" name="portalId"  value="" tooltipText="Type Client ID in this box" />
							  <a href="#" style="text-decoration:none; font-size:10px; font-family:'Trebuchet MS';" onclick="checkClientID()">
                             <font size="1.5" color="red" >Check Availability</font></a>
                              ...
                              <td width="27" id="img2" style="visibility:hidden" ><img src="images/ajax-loader.gif" height="20" /></td>
										<td width="192"><div style="width:190px;font-family:'Trebuchet MS'; height:20px;" id="resultClient"></div>
							  </td>
							</tr>
                            <%}%>
                            ...
                            <tr>
                              ...
                              <td width="5%" align="left">:</td>
                              <td width="46%" align="left"><input type="text" name="firstName" id="firstname" tooltipText="Type First Name in this box" />                                </td>
							</tr>
                            ...
                            <tr>
                              ...
                              <td width="5%" align="left">:</td>
                              <td width="46%" align="left"><input type="text" name="lastName" id="lastName"  tooltipText="Type Last Name in this box" /> </td>
							</tr>
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left"> <select name="companyType" id="firmtype" onchange="changeStyleCompanyType()" >
                                <option value="-1">Select</option>
                            ...
                            <tr>
                            <td colspan="100%" align="center"><h3 align="center" class="hd tabulardata">Address</h3></td>
                            </tr>
                           ...
                           <select name="state" id="Ostate" onchange="populatecities('office')">
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                                  <input type="text" name="pincode" id="Rpin"  onkeypress="return digitonly(this,event)" maxlength="6" tooltipText="Type 6 Digits Pin Code in this box" /></td>
                            </tr>
                          </table>                          
                          </td>
                    </tr>
                      ...
                      <td><h3 align="center" class="hd tabulardata">PAN Details</h3>
                    		...
                    		<span style="margin-left:0px; color:#3E3E3E;"> <input onclick="r_yes()" type="radio" name="same"  checked="checked" />&nbsp;Yes</span> 
                              ...
                              <tr id="tr_1">
                                ...
                                <td align="left">:</td>
                                <td align="left"><input name="panNo" id="staxno" maxlength="12" type="text" tooltipText="Type PAN Number in this box" /></td>
                              </tr>
                    ...
                    <tr>
                      ...
                      <%if(loginUserType.equalsIgnoreCase("portaladmin")) {%>
                      <input name="Submit" class="cls_btn" type="button" value="Submit" onclick="submitForm2()"/>
                      <%}else{ %>
                      <input name="Submit" class="cls_btn" type="button" value="Submit" onclick="submitForm()"/>
                      <%} %>
                          <input name="Submit" class="cls_btn" type="reset" value="Reset"  />                      </td>
                    </tr>
                  </table>
				</form>	
...
{
	//alert('here');
	var clientId=document.registration.portalId.value.replace(/^\s+|\s+$/, '');
	if(clientId== null || clientId=="")
	{
		alert("Your Form is Incomplete.");
		document.registration.portalId.focus();
		return false;
	}
...
return false;
 ...
 document.registration.action="mdsRegistration.action?param=registration";
...
var type=document.registration.portalId.value;
xmlHttp.onreadystatechange = printValuesClient;

xmlHttp.open("POST","mdsRegistration.action?param=checkClientID&clientID="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","mdsRegistration.action?param=checkMaildID&loginUserName="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","mdsRegistration.action?param=checkMobile&MobileNo="+type, true);
xmlHttp.send(null);
}


function printValuesClient()
{
...
var resultClient=document.getElementById('resultClient');
if(response1=="valid")
{

document.getElementById('img2').style.visibility="hidden";
response1="Valid Client ID."
resultClient.innerHTML=response1;
resultClient.style.color="green"
...
document.getElementById('img2').style.visibility="hidden";
response1="Invalid Client ID."
resultClient.innerHTML=response1;
resultClient.style.color="red"
document.regiestration.portalId.value="";
document.regiestration.portalId.focus();
}
}
}
}
