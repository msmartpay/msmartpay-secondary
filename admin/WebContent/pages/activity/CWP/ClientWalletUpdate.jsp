   ...
   <td  align="center" width="100%" valign="top"> <table cellpadding="0" cellspacing="0"  width="90%" align="center" border="0">
		...
		<tr>
		  ...
		  <table cellpadding="0" cellspacing="0" width="83%" align="left" border="0" class="mydata_tabl" id="border">
	              ...
	              <td colspan="4" height="15"></td>
				    ...
				    <tr>
				      ...
				      <td width="53%" align="left"><span class="tabl2">
				        <input type="text"  class="tabl2" name="clientName"/>
				      ...
				      <td width="8%" align="left">:</td>
				      <td width="53%" align="left"><span class="tabl2">
				        <input type="text"  class="tabl2" name="clientUrl"/>
				      </span></td>
				      </tr>
				      ...
				      <td width="8%" align="left">:</td>
				      <td width="53%" align="left"><span class="tabl2">
				        <input type="text"  class="tabl2" name="amount" maxlength="7" onkeypress="return digitonly(this,event)"/>
				      </span></td>
				      </tr>
                      <tr>
                ...
                <td  align="left"></td>
				<td align="left"></td>
				<td align="left" style="padding-left:0px"><input name="dumy" type="submit" value="Submit" class="cls_btn" id="demo" onclick="updateAmount()"/></td>
                </tr>
                 <tr>
                      <td colspan="4" height="15"></td>
                    </tr>
