...
document.getElementById("RM_LMTNLGaruda_Comm").focus();
return false;
}
if(WLCharge<totalCharge){
...
if(WLComm<totalComm){
alert("Commision for Reliance Land Line  Service Recharge is not permitted to set  more than "+limitComm.toFixed(2))
document.getElementById("RM_RelianceL_Comm").focus();
return false;
}
if(WLCharge<totalCharge){
alert("Charge for Reliance Land Line  Service Recharge is not permitted to set  more than "+limitCharge.toFixed(2))
document.getElementById("RM_RelianceL_Charge").focus();
return false;
}
}
...
if(WLComm<totalComm){
alert("Commision for TATA Land Line  Service Recharge is not permitted to set  more than "+limitComm.toFixed(2))
document.getElementById("RM_TATAL_Comm").focus();
return false;
}
if(WLCharge<totalCharge){
alert("Charge for TATA Land Line Service Recharge is not permitted to set  more than "+limitCharge.toFixed(2))
document.getElementById("RM_TATAL_Charge").focus();
return false;
}
}
...
if(WLComm<totalComm){
alert("Commision for TATA DOCOMO  Service Recharge is not permitted to set  more than "+limitComm.toFixed(2))
document.getElementById("RM_TATADOCOMO_Comm").focus();
return false;
}
if(WLCharge<totalCharge){
alert("Charge for TATA DOCOMO  Service Recharge is not permitted to set  more than "+limitCharge.toFixed(2))
document.getElementById("RM_TATADOCOMO_Charge").focus();
return false;
}
}
...
var criteria=document.update.PayBillDSCommCriteria.value;
var user=document.getElementById("userTypeForComm").value;

if(criteria=="PayBillDS")
{
	
document.update.action="UpdateDSPayBillWithDSID.action";
document.update.submit();
}	

if(criteria=="PayBillMD")
{
document.update.action="UpdateDSPayBillWithMDID.action";
document.update.submit();
}	
if(criteria=="clientID")
{
document.update.action="UpdateDSPayBillWithClientId.action";
document.update.submit();
}
}
}
...
function resetfunctionDS()
{
document.getElementById("check3").style.visibility="visible";
document.update.action="GetDetailsPayBillDS.action";
document.update.submit();
