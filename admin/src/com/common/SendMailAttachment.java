...
public class SendMailAttachment 
{
	...
	public static String  sendAttachMessage(String recipients[], String subject,String message,String from,String filepath1,String filepath2,String filepath3) throws MessagingException
	{
		boolean debug = true;
		...
		try {
			...
			System.out.println("Exception in sending mail  "+e.toString());
		}
		return sendStatus;
	}
}
