		  ...
		  <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0"  class="mydata_tabl" id="border">
			  ...
			  <tr><td valign="top" align="center"><div id="#" style="display:">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tbody>
                                    <tr>
                                      <td height="40" align="left" valign="middle" class="heading_mgs">Egen User Detail</td>
                                    </tr>
                                    ...
                                    <tbody style="background:#a74312;">
                                        <tr class="hd" align="center" style="background:#a74312;">
                                            ...
                                            <td width="6%" align="center" class="right_border"><strong style="color:#FFF;">Corporate Agent ID</strong></td>
                                            <td width="11%" align="center"  class="right_border"><strong style="color:#FFF;">Company Name</strong></td>
										  ...
										  %>
                                           <tr bgcolor="#ffffff" align="center" class="value_reg">
                                            ...
                                            <td align="center" style="padding-left:8px;border-bottom:1px solid #930;"><%=map.get("userID")%></td>
                                            <td align="center" style="padding-left:8px;border-bottom:1px solid #930;"><%=map.get("companyName")%></td>
