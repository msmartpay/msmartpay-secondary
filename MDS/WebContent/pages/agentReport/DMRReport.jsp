		  ...
		  <tr>
			...
			<tr>
				...
				<form name="Getreport"  method="post" action="DownloadReport.do" >	
					<input type="hidden" name="param" value="downloadDMR" />
			  		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="border" style="padding:25px 0 25px 0;">
		
					<tr class="mydates">
						<td width="10%"></td>
						<td><strong style="font-size:13px; font-family:'Trebuchet MS';"> Date</strong></td>
						<td><input readonly  type="text" id="from"  name="from" style="width:100px; height:27px;" /></td>
						<td><input readonly  type="text" id="to"  name="to" style="width:100px; height:27px;" /></td>
						<td><input  type="text" name="senderId" placeholder="Sender Mobile (Optional)" style="width:160px; height:27px;" /></td>
						<td align="right" valign="middle" height="30" class="hh" style="padding-right:150px">
						<input type="submit" style="height:27px; font-weight:bold;" value="Download DMR Report" />
