...
<form name="loginInfo" method="post" action="superAdminLogin.action">

<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" height="300" class="form11">
  <tr>
    
             <td>
			 <input type="hidden" name="userId" value="<%=loginId%>" />
				 <input type="hidden" name="param" value="checkloginInfo" />
                <td height="40"  align="center"><h3>Please wait while we are validating your login information</h3></td>
              </tr>
