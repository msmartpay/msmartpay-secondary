              ...
              <tr>
                <td valign="top" align="center" class="rounded-corners box_heights" ><table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
                    <tr>
                      ...
                      Finance Report > Channel</td>
                    </tr>
					<tr align="center"><td height="20" class="dyn_mgs"><%=message%></td></tr>
                    <tr>
...
<table cellpadding="0" cellspacing="0" width="750" align="center" class="mydata_tabl">
	...
	<select name="reportOf" class="searchtext">
			  ...
			  <option value="accountAdjustmentReport">Account Adjustment</option>
			  <option value="agentJournalReport">Journal - Agent</option>
			  <option value="distributorJournalReport">Journal - Distributor</option>
		      <option value="mdJournalReport">Journal - MDS</option>
			  <option value="portalJournalReport">Journal - Portal</option>
			  <option value="railTicketCancellationReport">Rail Ticket Cancellation Report</option>
			  <option value="TDRreport">TDR Report</option>
	</select>
	</td>
			</tr>
    ...
    <td width="7%" align="left">:</td>
    <td width="35%">
	<input type="text" id="datepickers"  name="toDate" />
	</td>
			</tr>
    ...
    <td width="7%" align="left"></td>
    <td width="35%">
	<input  type="button" value="Submit" class="cls_btn"  onclick="validateform()" />
	</td>
			</tr>
   ...
   <tr>
    <td width="100%" valign="top" align="center" height="100"></td>
  </tr>
  <tr>
