...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function getBankStatus(BankCode){
		...
		$.ajax({
		 	url:"bankIfscStatuseko.action?BankCode="+BankCode+"&SenderId="+SenderId,
			type : "GET",
			dataType: "text",
	...
	function verifyAcount(){
		...
		if ($('#verify').is(':checked')) {
			...
			if(bankCode==''){
				...
				$.ajax({
				 	url:"ajaxverifyAccounteko.action?SenderId="+SenderId+"&AccountNo="+BankAccount+"&BankName="+bankName+"&IFSC="+IFSC+"&bankCode="+bankCode,
					type : "GET",
					dataType: "json",
					success: function (data) {
						...
						if(statusCode=='0'){
							...
							//$('#addbeneAlert_msg').text(data.message);
							//$('#addbeneAlert').show();
						}else{
							...
							<div class="cta-txt">
                                <div class="row" align="center">
                                    <div class="table-responsive">
		                            	...
		                            	<form class="floating-labels" name="AddAccount" action="AddBeneAfterVerifyeko.action">
												<div class="col-md-12 form-group" align="left">
		                                           <h3 class="box-title">EAdd Beneficiary</h3>
		                                       </div>
