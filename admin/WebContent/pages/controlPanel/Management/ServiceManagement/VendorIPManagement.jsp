			...
			<tr>
				...
				<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0"  >
					<tr>
						...
						<table cellpadding="0" cellspacing="0" width="100%" align="center">
							<tr>
								<td height="40" align="left" valign="middle" class="heading_mgs">Vendor IP Management</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<tr><td height="20px" colspan="100%"></td></tr>
                                      <tr>
                                      <td width="30%"></td>
                                      <td  width="10%"><strong>Enter Vendor IP</strong></td><td width="10%" align="center">:</td>
                                      <td width="60%">
                                      <input type="text" name="vendorIp"  />
                                      </td>
                                      </tr>
                                      <tr>
                                      <td></td><td></td> <td></td>
