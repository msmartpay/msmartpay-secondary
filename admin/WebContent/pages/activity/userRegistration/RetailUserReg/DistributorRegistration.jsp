  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" >
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Distributor Registration</td>
              </tr>
              ...
              <tr>
				...
				<form name="registration" method="post" enctype="multipart/form-data" >
				  <table width="100%"  cellspacing="2" cellpadding="0" align="center">
                    <tr>
                      <td><h3 align="center" class="hd tabulardata">Personal Details</h3>
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center" class="mydata_tabl">
                            ...
                            <tr>
                              <td width="22%"></td>
                              <td width="33%" height="30" align="left"  class="form11">MDS ID<font size="1" color="red" >*</font></td>
                              <td width="5%" align="left">:</td>
                              <td width="46%" align="left"><input type="text" name="mdId" maxlength="20" value="" tooltipText="Type MDS ID in this box" />                              <a href="#" style="text-decoration:none; font-size:10px; font-family:'Trebuchet MS';" onclick="checkMdsID()">
                             <font size="1.5" color="red" >Check Availability</font></a> </td>
                              <td width="27" id="img2" style="visibility:hidden" ><img src="images/ajax-loader.gif" height="20" /></td>
										<td width="192"><div style="width:190px;font-family:'Trebuchet MS'; height:20px;" id="resultMDS"></div>
							  </td>
							</tr>
							...
							<tr>
                              ...
                              <input name="dob" style="width:220px; background:#FFF;" type="text"  id="datepicker" />
                           ...
                           <tr>
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                              <input name="mobileNo" id="Omobile" type="text" onkeypress="return digitonly(this,event)" maxlength="10" tooltipText="Type Mobile Number in this box" />
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                                  <input type="text" name="pincode" id="Opin" onkeypress="return digitonly(this,event)" maxlength="6" tooltipText="Type Pin Code in this box" /></td>
                            </tr>
                          </table>                          
                          </td>
                    </tr>
                    ...
                    <tr>
                      <td height="60" align="center" valign="middle" style="padding-left:50px"><input name="Submit" class="cls_btn" type="button" value="Submit"  onclick="submitForm()"/>
                          <input name="reset" class="cls_btn" type="reset" value="Reset" />                      </td>
                    </tr>
                  </table>
...
var mdId=document.registration.mdId.value.replace(/^\s+|\s+$/, '');
if(mdId== null || mdId=="")
{
alert("Please Enter MDS ID");
document.registration.mdId.focus();
return false;
}
...
document.registration.action="distributorRegistration.action?param=registration";
document.registration.submit();
}
}
...
var type=document.registration.mdId.value;
xmlHttp.onreadystatechange = printValuesMDSid;


xmlHttp.open("POST","distributorRegistration.action?param=checkMdsID&mdsID="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","distributorRegistration.action?param=checkUserName&loginUserName="+type, true);
xmlHttp.send(null);
}
...
xmlHttp.open("POST","distributorRegistration.action?param=checkMobileNo&mobileNo="+type, true);
xmlHttp.send(null);
}


function printValuesMDSid()
{
...
var resultMDS=document.getElementById('resultMDS');
if(response1=="valid")
{

document.getElementById('img2').style.visibility="hidden";
response1="Valid Master Distributor ID."
resultMDS.innerHTML=response1;
resultMDS.style.color="green"
...
document.getElementById('img2').style.visibility="hidden";
response1="Invalid Master Distributor ID."
resultMDS.innerHTML=response1;
resultMDS.style.color="red"
document.regiestration.mdId.value="";
document.regiestration.mdId.focus();
}
}
}
}
