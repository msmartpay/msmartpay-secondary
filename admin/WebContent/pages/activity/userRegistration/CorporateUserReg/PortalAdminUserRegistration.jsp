...
HashMap map=(HashMap) session.getAttribute("wlClientDetails");
String ShowcompanyName=(String)map.get("companyName");
  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" >
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Portal Admin Registration</td>
              </tr>
              ...
              <tr>
				...
				<form name="registration" method="post">
				  <table width="100%"  cellspacing="2" cellpadding="0" align="center"  class="form11">
                    <tr>
                      <td><h3 class="hd tabulardata" align="center">Personal Details</h3>
                          <table width="100%"  cellspacing="0" cellpadding="0" align="center"  class="mydata_tabl">
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left"><select name="designation" id="firmtype" >
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left"><%=ShowcompanyName%></td>
                            </tr>
                              ...
                              <td align="left">:</td>
                              <td align="left"><input name="emailId"  type="email" tooltiptext="Type Email ID in this box" onchange="checkemail();" />
                            ...
                            <tr>
                              ...
                              <td align="left">:</td>
                              <td align="left">
                              <input name="officialNumber" id="Omobile" type="text" onkeypress="return digitonly(this,event)" maxlength="10" tooltipText="Type 10 Digits Mobile Number in this box" />
                            ...
                            <tr>
                            <td colspan="100%" align="center"><h3 class="hd tabulardata" align="center">Address</h3></td>
                            </tr>
                    ...
                    <tr>
                      <td><h3 align="center" class="hd tabulardata">PAN Details</h3>
                            ...
                            <table width="100%"  cellspacing="0" cellpadding="0" align="left"  class="form11">
                              <tr>
                                <td width="9%"></td>
                                <td align="left" height="30" width="28%"  class="form11">PAN Card Status (Available on Your Name) <font size="1" color="red" >*</font></td>
                                <td align="left" width="1%">:</td>
                               
                                <td align="left" width="36%">
								
                    		<span style="margin-left:10px; color:#3E3E3E;"> 
                    		<input onclick="r_yes()" type="radio" name="same"  checked="checked" />&nbsp;Yes</span> 
                  			<span style="margin-left:50px; color:#3E3E3E;"> <input onclick="r_no()" type="radio" name="same"  /> &nbsp;No</span>            </td>
                    ...
                    <tr>
                      <td height="60" align="center" valign="middle" style="padding-left:50px"><input name="Submit2" type="button" value="Submit" class="cls_btn"  onclick="submitForm()"/>
                      <input name="Submit"  type="button" value="Reset" class="cls_btn"  onclick="reset();"/>                      </td>
                    </tr>
                  </table>
				</form>	
...
var officialNumber=document.registration.officialNumber.value.replace(/^\s+|\s+$/, '');
if(officialNumber== null || officialNumber=="" )
{
alert("Your Form is Incomplete.");
document.registration.officialNumber.focus();
return false;
}
...
document.registration.action="whiteLabelRegistration.action?param=registrationNextPage";
...
xmlHttp.open("POST","whiteLabelRegistration.action?param=checkEmailID&checkEmailID="+type, true);
xmlHttp.send(null);
}
...
createXMLHttpRequest();
var type=document.registration.officialNumber.value;
xmlHttp.onreadystatechange = printValuesEmails;


xmlHttp.open("POST","whiteLabelRegistration.action?param=checkUserMobile&Mobile="+type, true);
xmlHttp.send(null);
}
