...
<%
ArrayList distributorSearchList=(ArrayList)request.getAttribute("distributorSearchList");
int size=0;
if(distributorSearchList!=null){
size=distributorSearchList.size();
}else{
size=-1;
}
String DsName="";
                                        ...
                                        <tbody style="background:#a74312;">
                                         ...
                                         <%
                                          ...
                                          <tr bgcolor="#ffffff" align="center" class="value_reg bords">
                                            ...
                                            <%=distributorMap.get("portalId")%></td>
