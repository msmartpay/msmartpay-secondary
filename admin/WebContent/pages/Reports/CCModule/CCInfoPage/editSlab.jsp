...
<table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
  ...
  <tr>
                                    ...
                                    <table cellspacing="0" cellpadding="0" width="100%" align="center" class="tbls"  bgcolor="#a74312">
                                        <tbody>
                                          <tr align="center" height="20" class="hd">
                                            <td class="myborder"  rowspan="2" align="center"><strong style="color:#FFF;">S.N.</strong></td>
                                            <td class="myborder"  align="center" rowspan="2"><input type="checkbox"  id="selectall"  /></td>
                                            <td class="myborder"  width="15%" rowspan="2" align="center"><strong style="color:#FFF;">User ID</strong></td>
                                            <td class="myborder"  width="13%" rowspan="2" align="center"><strong style="color:#FFF;">Category</strong></td>
                                            <td class="myborder"  height="20" colspan="6" align="center" style="padding-left:0px"><strong style="color:#FFF;">Prepaid Commission</strong></td>
                                          </tr>
                                          <tr align="center" height="20" class="hd">
                                            <td class="myborder"  width="10%" height="25" style="padding-left:0px"><strong style="color:#FFF;">Deposit-1</strong></td>
                                            <td class="myborder"  width="10%" style="padding-left:0px"><strong style="color:#FFF;">Rate-1</strong></td>
                                            <td class="myborder"  width="11%" style="padding-left:0px"><strong style="color:#FFF;">Deposit-2</strong></td>
                                            <td class="myborder"  width="10%" align="center"><strong style="color:#FFF;">Rate-2</strong></td>
                                            <td class="myborder"  width="10%" align="center"><strong style="color:#FFF;">Deposit-3</strong></td>
                                            <td class="myborder"  width="10%" align="center"><strong style="color:#FFF;">Rate-3</strong></td>
                                          </tr>
                                          ...
                                          <tr align="center" bgcolor="#ffffff">
											...
											<input type="checkbox" name="checkpartial" class="case" id="chek<%=i %>" value="<%=i%>" /></td>
	...
	%>
                                           <th width="140" align="left" bgcolor="" style="padding-left:5px" scope="row"><strong>Portal ID</strong></th>
											<td width="15" bgcolor="#fbf7eb">:</td>
                                            <td width="156" bgcolor="#fbf7eb"><%=map.get("clientID").toString()%></td>
                                         </tr>
                                        <tr>
                                          <th align="left" bgcolor="" style="padding-left:5px" scope="row"><strong>Portal Name</strong></th>
                                          <td bgcolor="#FBF7EB">:</td>
                                          <td bgcolor="#FBF7EB"><%=map.get("companyName").toString()%></td>
                                        </tr>
                                        <tr>
                                          <th align="left" bgcolor="" style="padding-left:5px" scope="row"><strong>Portal Category</strong></th>
                                          <td bgcolor="#FBF7EB">:</td>
                                          <td bgcolor="#FBF7EB"><%=map.get("clientCategory").toString()%></td>
                                        </tr>
                                        <tr>
                                          <th align="left" bgcolor="" style="padding-left:5px" scope="row"><strong>Portal Type</strong></th>
                                          <td bgcolor="#FBF7EB">:</td>
                                          <td bgcolor="#FBF7EB"><%=clientType%></td>
                                       </tr>
                                       <tr>
                                          <td height="5" colspan="3" align="center" valign="middle" style="padding-left:0px"><img src="images/bg_image24.jpg" width="278" height="1" /></td>
                                       </tr>
                                       <tr>
                                          <th align="left" bgcolor="" style="padding-left:5px" scope="row"><strong>User ID</strong></th>
                                          <td bgcolor="#FBF7EB">:</td>
                                          <td bgcolor="#FBF7EB"><%=map.get("userID").toString()%></td>
                                       </tr>
                                       <tr>
      ...
      <select name="userCategory<%=i%>" id="select11" style="font-family:'Trebuchet MS'; color:#933; font-size:12px; font-weight:bold;" >
		<%
		...
		%>  
		 ...
		 <%}%>
            ...
            <input type="text" name="rate3<%=i%>" size="10"  onkeypress="retet" id="rate3<%=i+1%>" value="<%=map.get("userRateThree").toString()%>"/>
                          ...
                          <tr>
                            <td height="10" colspan="5" align="right"> <input type="hidden" name="typeOfuser" value="<%=typeOfuser%>" />
   ...
   <tr>
    <td width="100%" height="156" align="center" valign="bottom"></td>
  </tr>
