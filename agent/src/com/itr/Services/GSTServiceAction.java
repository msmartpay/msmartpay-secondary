...
public class GSTServiceAction extends ActionSupport {
	
	Logger logger=Logger.getLogger(GSTServiceAction.class);
	...
	public String execute() throws Exception{
		...
		try{
            ...
            if("GSTService".equalsIgnoreCase(param)) {
				return "GSTService";
			}
            
            else if("GSTServicesubmit".equalsIgnoreCase(param)) {
