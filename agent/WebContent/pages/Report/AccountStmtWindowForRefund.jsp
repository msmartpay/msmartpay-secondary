...
<table style="width:75%; height:400px; margin:auto;" border="0" align="center" cellpadding="0" cellspacing="0" >
                       ...
                       <tr>
                          ...
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("service1")%></td>
                      </tr>
                      ...
                      <tr>
                          ...
                          <td align="left" valign="top" class="tra_2">:</td>
                          <td align="left" valign="top" class="tra_2"><%=mapdata.get("actionOnBal")%></td>
                      </tr>
    ...
    <!--<tr>
                          <td colspan="4" align="center"  valign="middle">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="button"  value="Close" class="btn_sign" onclick="window.location='admin_panel/bus_index.html'"/></td>
