...
<%
HashMap agentRegistrationDetails=(HashMap)request.getAttribute("agentRegistrationDetails");
							...
							<tr>
                              ...
                              <tr>
                                ...
                                <td width="46%" align="left">
                                     ...
                                     <%=agentRegistrationDetails.get("completeAgentId")%>
                              ...
                              <td  align="left">:</td>
                              <td  align="left">
                            <%=agentRegistrationDetails.get("LoginID")%>
                                </td>
							</tr>
                              ...
                              <tr>
                                ...
                                <td  align="left">:</td>
                                <td align="left"><%=agentRegistrationDetails.get("password")%> </td>
                              </tr>
							  ...
							  <tr>
                                ...
                                <td  align="left">:</td>
                                <td align="left">
								<%=agentRegistrationDetails.get("agentLoginUrl")%>
