				 ...
				 <%if(cutOffBy.equalsIgnoreCase("ByAll")){%>
				  ...
				  <form name="ALLPortal"  method="post" action="cutoffAmount.action?param=UpdateCutOffPortalAll">
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td  width="100%" valign="middle" height="50" align="left" class="heading_mgs" >Cutoff for All Portal Admin</td>
                          </tr>
				  ...
				  <form name="PortalIDFORM" method="post" action="cutoffAmount.action?param=UpdateCutOffPortalID">
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td colspan="" valign="middle" height="50" align="left" class="heading_mgs" ><strong>Set Cutoff Amount for Portal Admin ID (<%=EnterUserId%>)</strong></td>
                          </tr>
                          <tr>
...
<tr>
  <td width="100%" height="137" valign="top" align="center">
</td>
</tr>
<tr>
