...
public class BusBookingDao {
	...
	public String saveBooking(String TransactionID,String TransactionNo,long agentID,String userTrackId,JSONArray passengerList,String customerTitle,String customerName,
			...
			String BusName,String TransportName,String ArrivalTime,String departureTime,String Ipaddress,String originName,String destinationName, int transportId) {
		...
		try
		{
			...
			String sql="insert into Bus_Passenger_Details (User_Track_Id, Pass_Name, Seat_No, Seat_Type, Gender, Age, Fare, Place, Boarding_Time, "
					+ "Boarding_Address, Boarding_Land_Mark, Boarding_Contact_Number,transportID) values (?,?,?,?,?,?,?,?,?,?,?,?,? )";
			...
			for (int i = 0; i < passengerList.size(); i++) {
				...
				System.out.println("passenger.getString"+passenger.getString("SeatTypeId"));
				
				
				pstmt.setString(1, userTrackId);
				pstmt.setString(2, passenger.getString("PassengerName"));
				pstmt.setString(3, passenger.getString("SeatNo"));
				pstmt.setString(4, passenger.getString("SeatTypeId"));
				pstmt.setString(5, passenger.getString("Gender"));
				pstmt.setString(6, passenger.getString("Age"));
				pstmt.setString(7, passenger.getString("Fare"));
				pstmt.setString(8, "");
				pstmt.setString(9, passenger.getString("Time"));
				pstmt.setString(10, passenger.getString("Address"));
				pstmt.setString(11, passenger.getString("LandMark"));
				pstmt.setString(12, passenger.getString("ContactNumber"));
				pstmt.setInt(13, transportId);
			...
			cstmt.setInt(27, transportId);
			cstmt.registerOutParameter(28, java.sql.Types.VARCHAR);
			cstmt.execute();
			//con.commit();
			status=cstmt.getString(28);
