...
///Change date fromat Jaswin Kumar Prusty
var _27=day+"-"+_25+"-"+_24;
_13.value=_27;
var ret = hide();
}
...
if(_2f.getAttribute("id")==strCheckoutId){
_37=$F(strCheckinName);
}
}
...
var _3d="<div class='close'><a href='javascript:hideCalendarControl();'><img src='http://www.quickbooker.com/APP_Theme/images/close.gif' /></a></div>";
if((_d>(_35.getMonth()+1))||(_c>_35.getFullYear())){
_3d+="<div class='cal_control'><a class='cal_control' href='#' onclick='changeCalendarControlMonth(-1,\""+_2f.getAttribute("id")+"\");return false'>Prev Month</a></div>";
}else{
...
_36.setFullYear(_c,_d-1,_30);
//  shiva  calender day disable in following line just mention no of day in addDays functions

// Jaswin Kumar Prusty add days from current date 
var _40=compareDates(_36,addDays(_35,0));
var _41;
if(_38!=""){
...
if((_d>(_35.getMonth()+1))||(_c>_35.getFullYear())){
_3d=_3d+"<div class='cal_control'><a href='javascript:hideCalendarControl();'>Close|</a><a class='cal_control' href='#' onclick='changeCalendarControlMonth(-1,\""+_2f.getAttribute("id")+"\");return false'>Prev</a>&nbsp;<a class='cal_control' href='#' onclick='changeCalendarControlMonth(1,\""+_2f.getAttribute("id")+"\");return false'>Next</a></div>";
}else{
_3d=_3d+"<div class='cal_control'><a href='javascript:hideCalendarControl();'>Close|</a>&nbsp;<a class='cal_control' href='#' onclick='changeCalendarControlMonth(1,\""+_2f.getAttribute("id")+"\");return false'>Next</a></div>";
}
//_3d=_3d+"<div class='cal_control'><a href='javascript:hideCalendarControl();'>Close|</a><a class='cal_control' href='#' onclick='changeCalendarControlMonth(1,\""+_2f.getAttribute("id")+"\");return false'>>></a></div>";
return _3d;
}
this.show=show;
...
if(_44.id==strCheckoutId){
_47=new String($(strCheckinName).value);
var _46=_47.split("-");
_10=parseInt(_46[1],10);
_11=parseInt(_46[0],10);
_f=parseInt(_46[2],10);
...
function showCalendarControl(_4c,num,pagelocation)
{
    if(pagelocation == 1)
    {
        strCheckinName = "Checkin";
        strCheckoutName = "Checkout";
        strCheckinId = "Checkin";
        strCheckoutId = "Checkout";
    }
    if(pagelocation == 3)
    {
        strCheckinName = "Checkin1";
        strCheckoutName = "Checkout2";
        strCheckinId = "Checkin1";
        strCheckoutId = "Checkout2";
    }
    if(pagelocation == 2)
    {
        strCheckinName = "ctl00_QBPlaceHolder_SearchEngine_Checkin";
        strCheckoutName = "ctl00_QBPlaceHolder_SearchEngine_Checkout";
        strCheckinId = "ctl00_QBPlaceHolder_SearchEngine_Checkin";
        strCheckoutId = "ctl00_QBPlaceHolder_SearchEngine_Checkout";
    }
    if(pagelocation == 6)
    {
        strCheckinName = "ctl00_ContentPlaceHolderB2B_SearchEngine_Checkin";
        strCheckoutName = "ctl00_ContentPlaceHolderB2B_SearchEngine_Checkout";
        strCheckinId = "ctl00_ContentPlaceHolderB2B_SearchEngine_Checkin";
        strCheckoutId = "ctl00_ContentPlaceHolderB2B_SearchEngine_Checkout";
    }
    if(pagelocation == 4)
    {
        strCheckinName = "ctl00_QBPlaceHolder_Checkin";
        strCheckoutName = "ctl00_QBPlaceHolder_Checkout";
        strCheckinId = "ctl00_QBPlaceHolder_Checkin";
        strCheckoutId = "ctl00_QBPlaceHolder_Checkout";
    }
    if(pagelocation == 5)
    {
        strCheckinName = "ctl00_ContentPlaceHolderB2B_Checkin";
        strCheckoutName = "ctl00_ContentPlaceHolderB2B_Checkout";
        strCheckinId = "ctl00_ContentPlaceHolderB2B_Checkin";
        strCheckoutId = "ctl00_ContentPlaceHolderB2B_Checkout";
    }
...
var ret = calendarControl.setDate(_4e,_4f,day);



var date1=new Date(parseInt(_4e), parseInt(_4f)-1, parseInt(day));
//Jaswin Kumar Prusty difference between Checkindate and Checkout date
var newDate = addDays(date1,1);
        var newmonth = 0;
        var newday = 0;
        ...
        //alert(document.getElementById(strCheckinId));
    
        if(ret != strCheckoutId)
        {
        //alert(strCheckoutId);
        document.getElementById(strCheckoutId).value = finalDate;
        }
}
...
function closeCal(e){
if($("CalendarControl1").style.display=="block"){
var _55=0;
if(!e){
var e=window.event;
}
