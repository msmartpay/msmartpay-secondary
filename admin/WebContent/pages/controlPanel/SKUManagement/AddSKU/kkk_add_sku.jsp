...
$("#comm_val").click(function(){
	...
	var txt = document.getElementById('input_comm1');
	...
	var txt = document.getElementById('input_comm2');
    txt.addEventListener('keyup', myFunc);
	...
	//var num = parseFloat(document.getElementById('input_comm1').value);
   //var new_num = Math.round(num).toFixed(2);
	
	//part of code two decimal End
					...
					<table  cellspacing="0" cellpadding="0" align="center" class="hr_tbls">
                      ...
                      <tr>
                         <td width="30%"></td>
                          ...
                          <td>:</td>
                          <td>
                      <input type="text" name="Comm" class="mytextbox" maxlength="5" id="input_comm1"   />                         </td>
                        </tr>
                        ...
                        <td width="30%"></td>
                          ...
                          <td>:</td>
                          <td>
                          <input type="text" name="Charge" class="mytextbox" maxlength="5" id="input_comm2"  />                            </td>
                        </tr>
            ...
            <tr>
              ...
              <table cellspacing="0" cellpadding="0" width="90%" align="center" class="form11 tbls" id="mytables">
                 ...
                 <td width="10%" align="center"><span><%=DisplaysubService%><input type="hidden" name="DisplaysubService" value="<%=DisplaysubService%>"/></span></td>
                                            ...
                                            <input id="input_comm" class="mytextbox" type="text"  maxlength="5" value="0" style="width:75px; height:15px; color:#000;font-size:12px; opacity:0.6;" 
                                            ...
                                            <td width="7%" align="center">
                                            <input type="text" id="input_charge" maxlength="5" class="mytextbox" value="0" style="width:75px; height:15px; color:#000;font-size:12px; opacity:0.6;" 
                                            onfocus="if(this.value =='0') this.value=''"  onblur="if(this.value=='') this.value='0'" /></td>
