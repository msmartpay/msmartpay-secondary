...
public class AccountAdjustmentDao {

	public static HashMap<String, Object> getAccountAgentData(String clientFlag,String requestUserId) 
	{
	...
	public static String validateId(String requestUserId,String userId,String UserType) 
	{
		...
		try 
		{
			...
			{
				sql="select User_id from Admin_User_details where Portal_id=(select Client_Id from MD_Details where md_id=(select md_id from distributor_details where distributor_id=(select distributor_id from agent_details where agent_initial+convert(varchar(10),agent_id)='"+requestUserId+"')))";
			}
			if(UserType.equalsIgnoreCase("Portal"))
			{
				sql="select User_id from Admin_User_details where Portal_id='"+requestUserId+"'";
			}
			if(UserType.equalsIgnoreCase("Distributor"))
			{
				sql="select User_id from Admin_User_details where Portal_id=(select Client_Id from MD_Details where md_id=(select md_id from distributor_details where distributor_initial+convert(varchar(10),distributor_id)='"+requestUserId+"'))";
			}
			if(UserType.equalsIgnoreCase("Master Distributor"))
			{
				sql="select User_id from Admin_User_details where Portal_id=(select Client_Id from MD_Details where MD_initial+convert(varchar(10),md_id)='"+requestUserId+"')";
			}
			...
			while (it.hasNext()) 
			{
				String user_id = ""+(BigInteger) it.next();
	...
	public static HashMap<String, Object> getAccountData(String userType,String requestUserId)
	{
		 HashMap<String,Object> DataMap=new HashMap<String,Object>();
		 Session session=null;
		 Query query = null;
	...
	public static HashMap<String, Object> getAccountPortalData(String requestUserId) 
	{
		 HashMap<String,Object> DataMap=new HashMap<String,Object>();
		 Session session=null;
	...
	public static HashMap<String, Object> getAccountAPIData(String requestUserId) 
	{
		 HashMap<String,Object> DataMap=new HashMap<String,Object>();
		 Session session=null;
	...
	public static String updateAgentAmount(String iDNo, String requestUserId,double amount,String loginType, String loginUserid, String actionType,
			String internalRemark, String externalRemark, int userOnlyId,String ipAddress,String UserType)
	{
		...
		try 
		{
			...
			CS=con.prepareCall("{call  Admin_Account_Management(?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
	...
	public static String CheckUserAmount(double amount,String actionType, int userOnlyId, String userType) 
	{
		Session session=null;
		String status="invalid";
		Connection con=null;
