  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Activity Admin</td>
              </tr>
              
              <tr>
                <td valign="top" align="center"><form  name="ActivityUserForm" method="post">
                    <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0"  class="form11" id="border">
                      <tr>
					  ...
					  <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" class="mydata_tabl">
                        ...
                        <td valign="middle" width="36%"><select name="selectActivityType">
							...
							<option value="selfReq">Self-Fund Request</option>
							
							<option value="TBReq">Trade Balance Request</option>
                            <option value="TBPush">Trade Balance Push</option>
							<option value="fundTransfer">Internal Transfer</option>
...
}if(selectActivityType=="fundTransfer"){
	
  document.ActivityUserForm.action="FundTransfer.action?param=FundTransferRequest";
  document.ActivityUserForm.submit();
