  ...
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="90%" align="center" border="0" class="newbg">
        <tr>
          ...
          <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
              <tr>
                <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Super Admin</td>
              </tr>
                    ...
                    <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0"   id="border">
					  ...
					  <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" class="mydata_tabl">
                        ...
                        <td valign="middle" width="36%"><select name="selectActivityType">
							...
							<option value="selfAction">Self-Action</option>
							<option value="activityReq">Portal Admin Request</option>
                            <option value="portalReq">Portal Admin Push</option>
							<option value="cwp">C W P</option>
                      ...
                      <tr>
                        <td width="31%"></td>
                        <td width="11%"></td>
                        <td><input name="Submit" type="button" value="Continue" class="cls_btn" onclick="submitForm()"/></td>
                        <td></td>
                      </tr>
                      <tr>
...
if(selectActivityType=="selfAction"){
	
  document.ActivityUserForm.action="TBRequest.action";
  document.ActivityUserForm.submit();
  
}
	
if(selectActivityType=="activityReq"){
...
if(selectActivityType=="portalReq"){
	
  document.ActivityUserForm.action="TBTransfer.action";
  document.ActivityUserForm.submit();
  
}
if(selectActivityType=="cwp"){
