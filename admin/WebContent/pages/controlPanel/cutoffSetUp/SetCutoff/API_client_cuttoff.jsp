				  ...
				  <tr>
                    <td><div id="ds1" style="display:block">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="mydata_tabl">
                          <tr>
                            <td  width="100%" valign="middle" height="50" align="left" class="heading_mgs" >Cutoff for All Client</td>
                          </tr>
                          <tr>
						  <tr><td  colspan="10" align="center" class="dyn_mgs"><%=message%></td></tr>
                            ...
                            <tr><td height="50px" colspan="100%"></td></tr>
                                <tr>
                                  <td width="15%"></td>
                                  <td width="33%" height="35"  align="left"><strong>Set Cutoff Amount for All API Client</strong></td>
                                  
                                  <td class="mdcolor"><input name="cutoffAmount"  type="text" class="style2"  value="" onkeypress="return digitonly(this,event)" maxlength="7" />
                                  </td>
                             <input type="hidden" value="<%=ipAddress%>" name="ipAddress" />
                                ...
                                <tr>
                                  ...
                                  <td class="mdcolor"><input type="button" class="cls_btn" value="Update" onclick="checkAllValidation()"/>
                                  </td>
							    </tr>
                                <tr><td height="50px" colspan="100%"></td></tr>
                          ...
                          <tr>
                            <td width="100%" align="center" height="80" valign="middle"></td>
                          </tr>
                        </table>
                      </div></td>
                  </tr>
				  ...
				  <tr>
                    <td valign="top">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                          <tr>
                            <td colspan="" valign="middle" height="40" align="left" 
class="heading_mgs"><strong>Set Cutoff Amount for Client ID (Client ID:</strong> <%=EnterUserId%>)</td>
                          </tr>
                          <tr>
                            <td align="center" width="100%"><table width="86%"  cellspacing="0" cellpadding="0" align="center" bgcolor="#a74312" class="tbls">
                                <tr align="center" bgcolor="#930">
                                  ...
                                  <td width="12%" style="color:#FFF;">Remark For Client</td>
                                </tr>
                                <tr align="center" bgcolor="#ffffff">
                                  ...
                                  <td class="mdcolor"><input name="cutoffAmount" id="cutoffAmountID" type="text" style="width:122px;"  value="<%=getData.get("cutString")%>" onkeypress="return digitonly(this,event)" maxlength="7"/></td>
                                  ...
                                  <td class="mdcolor"><input type="text" name="RemarkAdmin" maxlength="100"></td>
                                   ...
                                   <td class="mdcolor"><input type="text" name="RemarkOther" maxlength="100"></td>
                          ...
                          <tr>
                            <td width="100%" align="right" height="40" valign="middle" style="padding-right:90px"><input type="button" onclick="ValidateApiId()" class="cls_btn" value="Update"/></td>
                          </tr>
                        </table>
                   </td>
                  </tr>
...
<tr>
  <td width="100%" height="157" valign="top" align="center">
</td>
</tr>
<tr>
