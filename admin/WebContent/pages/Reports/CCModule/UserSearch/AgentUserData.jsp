		  ...
		  <table cellpadding="0" cellspacing="0" width="86%" align="center" border="0"  class="mydata_tabl" id="border">
			  ...
			  <tr><td valign="top" align="center"><div id="#" style="display:">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tbody>
                                    <tr>
                                      <td height="40" align="left" valign="middle" class="heading_mgs" >Agent Detail</td>
                                    </tr>
                                    ...
                                    <tbody >
                                        <tr class="hd tabulardata" align="center" >
                                            <td width="6%" align="center" height="25" class="right_border" style="border-left:none;"><strong style="color:#FFF;">S.N.</td>
                                            <td width="6%" align="center" class="right_border"><strong style="color:#FFF;">Portal ID</strong></td>
                                            <td width="11%" align="center" style class="right_border"><strong style="color:#FFF;">Portal Name</strong></td>
                                            ...
                                            <td width="8%" class="right_border"> <strong style="color:#FFF;">Agent ID</strong></td>
                                            <td width="14%" align="center" class="right_border"><strong style="color:#FFF;">Company Name</strong></td>
										  ...
										  %>
                                           <tr bgcolor="#ffffff" align="center" class="value_reg">
                                            <td align="center" height="25" style="border-left:none; border-bottom:1px solid #930;">1</td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("ClientID")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("compnayName")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("MDID")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("DSID")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("AGID")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("UsercompanyName")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("UserName")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;"><%=map.get("loginStatus")%></td>
                                            <td align="center" style="border-bottom:1px solid #930;border-right:1px solid #930;"><%=(String)map.get("blockStatus")%></td>
											</tr>
											<%}%>
                                      </tbody>
                                      </table></td>
