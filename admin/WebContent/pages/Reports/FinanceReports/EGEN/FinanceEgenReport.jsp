        ...
        <tr>
          <td valign="top" align="center"><table cellpadding="0" cellspacing="0" width="100%" align="center" border="0" >
              <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%" align="center" border="0">
                    <tr>
                      <td  width="100%" valign="middle" height="40" align="left" class="heading_mgs">Finance  Report > EGEN</td>
                    </tr>
...
<table cellpadding="0" cellspacing="0" width="750" align="center" class="mydata_tabl">
    ...
    <td width="35%">
	<select name="reportofegen" class="searchtext" >
			  <option value="Select">Select</option>
        	  <option value="accadjustreport">Account Adjustment</option>
			  <option value="livedepositfirst">Client Deposit</option>
			  <option value="apiJournal">Journal - EGEN</option>
            </select></td>
			</tr>
    ...
    <td width="7%" align="left">:</td>
    <td width="35%">
	<input type="text" id="datepicker"  name="fromDate" /></td>
			</tr>
    ...
    <td width="7%" align="left">:</td>
    <td width="35%">
	<input type="text"  id="datepickers"  name="toDate" /></td>
			</tr>
    ...
    <td width="7%" align="left"></td>
    <td width="35%">
	<input name="Input" type="button" value="Submit" class="cls_btn" onclick="validateform()" /></td>
			</tr>
